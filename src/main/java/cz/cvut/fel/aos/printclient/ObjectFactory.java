 ...
 * generated in the cz.cvut.fel.aos.printclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _PrintResponse_QNAME = new QName("http://service.printing.aos.fel.cvut.cz/", "printResponse");
    private final static QName _Print_QNAME = new QName("http://service.printing.aos.fel.cvut.cz/", "print");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cz.cvut.fel.aos.printclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.printing.aos.fel.cvut.cz/", name = "printResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.printing.aos.fel.cvut.cz/", name = "print")
